...
--3. List the manager of each department along with their department number, 
	...
	--USE tables: dept_manager, departments, employees
...
--Use tables: dept_emp, employees, departments
...
--whose last name begins with the letter 
--Use employees table
